const apikey="563492ad6f9170000100000156370cb4388249f7aec02f804336740f"; //use the apikey you have generated
...
function display_images(response){
    ...
    response.photos.forEach((image) => {
        ...
        photo.onclick = function showphoto(){
            window.location.href =image.src.large;
        }
    });
}
